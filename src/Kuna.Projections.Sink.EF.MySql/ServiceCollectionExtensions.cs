...
public static class ServiceCollectionExtensions
{
    ...
    public static IProjectionRegistrationBuilder<TState> UseMySqlDataStore<TState, TDataContext>(this IProjectionRegistrationBuilder<TState> builder, string? schema = null)
        where TState : class, IModel, new()
        where TDataContext : DbContext, IProjectionDbContext
    {
